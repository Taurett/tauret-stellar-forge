...
const translations = {
  en: {
    ...
    // Trust badges
    'trust.heading': 'Why shop with TAURET',
    'trust.securePayment.title': 'Secure Payment',
    'trust.securePayment.desc': '256-bit SSL encrypted',
    'trust.freeReturns.title': 'Free Returns',
    'trust.freeReturns.desc': '30-day return policy',
    'trust.fastShipping.title': 'Fast Shipping',
    'trust.fastShipping.desc': '2-5 business days',
    'trust.qualityGuarantee.title': 'Quality Guarantee',
    'trust.qualityGuarantee.desc': 'Tested by athletes',
    'trust.support.title': '24/7 Support',
    'trust.support.desc': 'We reply within hours',

    // Help / FAQ
    'help.menu': 'Help & FAQ',
    'help.kicker': '// Help Center',
    'help.title': 'How can we help?',
    'help.subtitle': 'Answers to the most common questions about orders, shipping, returns, and sizing.',
    'help.cat.shipping': 'Shipping',
    'help.cat.returns': 'Returns & Refunds',
    'help.cat.orders': 'Orders & Account',
    'help.cat.payments': 'Payments',
    'help.cat.sizing': 'Sizing & Fit',
    'help.q.shipTime': 'How long does shipping take?',
    'help.a.shipTime': 'Orders ship within 1-2 business days. Delivery takes 2-3 days within Romania, 3-5 days within the EU, and 5-10 days worldwide.',
    'help.q.shipCost': 'How much does shipping cost?',
    'help.a.shipCost': 'A flat shipping rate is applied per zone at checkout. The exact amount is shown before you pay — no surprises.',
    'help.q.shipWhere': 'Where do you ship to?',
    'help.a.shipWhere': 'We ship to Romania, the European Union, and most countries worldwide. Available zones are shown at checkout.',
    'help.q.shipTrack': 'Can I track my order?',
    'help.a.shipTrack': 'Yes — once your order ships you will receive a tracking number. You can also follow real-time status from "My Orders".',
    'help.q.returnWindow': 'What is your return policy?',
    'help.a.returnWindow': 'You have 30 days from delivery to request a return. Items must be unworn, unwashed, and in original packaging with tags.',
    'help.q.returnHow': 'How do I start a return?',
    'help.a.returnHow': 'Open the order from "My Orders", click "Start a return", select a reason and (optionally) attach photos. We review every request manually.',
    'help.q.refundTime': 'How long do refunds take?',
    'help.a.refundTime': 'After we approve your return, refunds are issued to the original payment method and typically appear in 5-10 business days.',
    'help.q.exchange': 'Can I exchange for a different size?',
    'help.a.exchange': 'Yes. Start a return for the wrong size and place a new order for the correct one — this is the fastest way to get the right fit.',
    'help.q.guest': 'Can I checkout as a guest?',
    'help.a.guest': 'Absolutely. Just enter your email at checkout. If you later sign up with the same email, your past orders are linked automatically.',
    'help.q.orderEdit': 'Can I edit my order after placing it?',
    'help.a.orderEdit': 'Contact us at info@tauret.com as soon as possible. We can update details only before the order is marked as shipped.',
    'help.q.orderCancel': 'Can I cancel my order?',
    'help.a.orderCancel': 'Yes, while it is still in "Processing" status. Once shipped, you will need to use our return process instead.',
    'help.q.payMethods': 'Which payment methods do you accept?',
    'help.a.payMethods': 'All major credit/debit cards (Visa, Mastercard, Amex), Apple Pay, Google Pay, and Link — securely processed by Stripe.',
    'help.q.paySecure': 'Is my payment information safe?',
    'help.a.paySecure': 'Yes. We never store your card details. Payments are handled by Stripe, a PCI-DSS Level 1 certified provider.',
    'help.q.currency': 'Which currencies are supported?',
    'help.a.currency': 'EUR by default and RON when browsing in Romanian. The currency shown at checkout is the one you will be charged in.',
    'help.q.sizeGuide': 'Where can I find a size guide?',
    'help.a.sizeGuide': 'Every product page has a "Size Guide" link with detailed measurements for top, bottom, and shoes.',
    'help.q.fit': 'How does TAURET apparel fit?',
    'help.a.fit': 'Our cuts are anatomical and athletic. If you are between sizes and prefer a relaxed feel, size up; for a compression fit, take your usual size.',
    'help.stillNeed.title': 'Still need help?',
    'help.stillNeed.desc': 'Our team replies within a few hours during business days.',
  ...
  ro: {
    ...
    // Trust badges
    'trust.heading': 'De ce să cumperi de la TAURET',
    'trust.securePayment.title': 'Plată Securizată',
    'trust.securePayment.desc': 'Criptare SSL pe 256 biți',
    'trust.freeReturns.title': 'Retururi Gratuite',
    'trust.freeReturns.desc': 'Politică de retur 30 de zile',
    'trust.fastShipping.title': 'Livrare Rapidă',
    'trust.fastShipping.desc': '2-5 zile lucrătoare',
    'trust.qualityGuarantee.title': 'Calitate Garantată',
    'trust.qualityGuarantee.desc': 'Testat de atleți',
    'trust.support.title': 'Suport 24/7',
    'trust.support.desc': 'Răspundem în câteva ore',

    // Help / FAQ
    'help.menu': 'Ajutor & Întrebări',
    'help.kicker': '// Centru de Ajutor',
    'help.title': 'Cu ce te putem ajuta?',
    'help.subtitle': 'Răspunsuri la cele mai frecvente întrebări despre comenzi, livrare, retururi și mărimi.',
    'help.cat.shipping': 'Livrare',
    'help.cat.returns': 'Retururi & Rambursări',
    'help.cat.orders': 'Comenzi & Cont',
    'help.cat.payments': 'Plăți',
    'help.cat.sizing': 'Mărimi & Potrivire',
    'help.q.shipTime': 'Cât durează livrarea?',
    'help.a.shipTime': 'Comenzile sunt expediate în 1-2 zile lucrătoare. Livrarea durează 2-3 zile în România, 3-5 zile în UE și 5-10 zile la nivel mondial.',
    'help.q.shipCost': 'Cât costă livrarea?',
    'help.a.shipCost': 'Se aplică o tarifă fixă pe zonă la checkout. Suma exactă este afișată înainte de plată — fără surprize.',
    'help.q.shipWhere': 'În ce țări livrați?',
    'help.a.shipWhere': 'Livrăm în România, Uniunea Europeană și majoritatea țărilor din lume. Zonele disponibile apar la checkout.',
    'help.q.shipTrack': 'Pot urmări comanda?',
    'help.a.shipTrack': 'Da — la expediere primești un cod de tracking. Poți urmări statusul și din "Comenzile Mele".',
    'help.q.returnWindow': 'Care este politica de retur?',
    'help.a.returnWindow': 'Ai 30 de zile de la livrare pentru a iniția un retur. Produsele trebuie să fie nepurtate, nespălate și în ambalajul original cu etichete.',
    'help.q.returnHow': 'Cum inițiez un retur?',
    'help.a.returnHow': 'Deschide comanda din "Comenzile Mele", apasă "Inițiază un retur", alege un motiv și (opțional) atașează fotografii. Verificăm fiecare cerere manual.',
    'help.q.refundTime': 'Cât durează rambursările?',
    'help.a.refundTime': 'După aprobarea returului, rambursarea se face pe metoda originală de plată și apare în 5-10 zile lucrătoare.',
    'help.q.exchange': 'Pot schimba pentru o altă mărime?',
    'help.a.exchange': 'Da. Inițiază un retur pentru mărimea greșită și plasează o comandă nouă pentru cea corectă — este cel mai rapid mod.',
    'help.q.guest': 'Pot cumpăra fără cont?',
    'help.a.guest': 'Absolut. Introdu doar email-ul la checkout. Dacă te înregistrezi ulterior cu același email, comenzile sunt asociate automat.',
    'help.q.orderEdit': 'Pot modifica comanda după plasare?',
    'help.a.orderEdit': 'Contactează-ne la info@tauret.com cât mai repede. Putem face modificări doar înainte ca aceasta să fie expediată.',
    'help.q.orderCancel': 'Pot anula comanda?',
    'help.a.orderCancel': 'Da, cât timp este în statusul "În procesare". După expediere, va trebui să folosești procesul de retur.',
    'help.q.payMethods': 'Ce metode de plată acceptați?',
    'help.a.payMethods': 'Toate cardurile principale (Visa, Mastercard, Amex), Apple Pay, Google Pay și Link — procesate securizat de Stripe.',
    'help.q.paySecure': 'Sunt datele mele de plată în siguranță?',
    'help.a.paySecure': 'Da. Nu stocăm niciodată datele cardului. Plățile sunt gestionate de Stripe, certificat PCI-DSS Nivel 1.',
    'help.q.currency': 'Ce valute sunt acceptate?',
    'help.a.currency': 'EUR implicit și RON când navighezi în limba română. Valuta afișată la checkout este cea în care vei fi taxat.',
    'help.q.sizeGuide': 'Unde găsesc ghidul de mărimi?',
    'help.a.sizeGuide': 'Fiecare pagină de produs are un link "Ghid Mărimi" cu măsurători detaliate pentru top, jos și încălțăminte.',
    'help.q.fit': 'Cum se potrivesc produsele TAURET?',
    'help.a.fit': 'Tăieturile noastre sunt anatomice și atletice. Dacă ești între mărimi și preferi o senzație lejeră, ia o mărime mai sus; pentru fit de compresie, ia mărimea ta obișnuită.',
    'help.stillNeed.title': 'Mai ai întrebări?',
    'help.stillNeed.desc': 'Echipa noastră răspunde în câteva ore în zilele lucrătoare.',
